...
describe('calculate the histogram', function () {
  it('check getHistogram method', function () {
    let image = new _common.Image(1, 2, [230, 83, 120, 255, 100, 140, 13, 1]);
  ...
  it('check histogram property', function () {
    let image = new _common.Image(1, 4, [230, 255, 230, 255, 230, 255, 13, 1], {
      kind: 'GREYA'
    });
  ...
  it('check histogram for 1 bit image', function () {
    let image = new _common.Image(5, 5, [0, 0, 0, 0, 0, 0, 255, 255, 255, 0, 0, 255, 255, 255, 0, 0, 255, 255, 255, 0, 0, 0, 0, 0, 0], {
      kind: 'GREY'
    });
