...
describe('resize', function () {
  describe('using a factor', function () {
    it('up - even dimensions', function () {
      const image = new _common.Image(10, 12);
    ...
    it('up - decimal factor', function () {
      const image = new _common.Image(9, 13);
      const result = image.resize({
        factor: 1.5
      });
  ...
  describe('binary images using a factor', function () {
    it('up - 2 factor', function () {
      let binary = new _common.Image(2, 2, [144], {
        kind: 'BINARY'
      });
      let newImage = binary.resize({
        factor: 2
      });
    ...
    it('down - 0.5 factor', function () {
      let binary = new _common.Image(4, 4, [204, 51], {
        kind: 'BINARY'
      });
      let newImage = binary.resize({
        factor: 0.5
