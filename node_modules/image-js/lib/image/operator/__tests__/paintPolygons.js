...
describe('we check paintPolygons', function () {
  it('should yield the painted image with 2 boxes', function () {
    ...
    image.paintPolygons(polygons, {
      colors: ['red', 'blue']
    });
    let grey = image.grey();
    let expected = [0, 54, 54, 54, 0, 0, 54, 0, 54, 0, 0, 54, 54, 54, 0, 0, 18, 18, 18, 0, 0, 18, 18, 18, 0];
  ...
  it('should yield the painted image with 2 boxes filled', function () {
    ...
    let grey = image.grey();
    let expected = [0, 54, 54, 54, 0, 0, 54, 54, 54, 0, 0, 54, 54, 54, 0, 0, 54, 54, 54, 0, 0, 54, 54, 54, 0];
    expect(Array.from(grey.data)).toStrictEqual(expected);
  });
});