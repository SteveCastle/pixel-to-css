...
describe('calculate the overlap with another image', function () {
  it('check identical images without shift', function () {
    let image = new _common.Image(1, 2, [0, 0, 0, 0, 255, 255, 255, 255]);
    let image2 = new _common.Image(1, 2, [0, 0, 0, 0, 255, 255, 255, 255]);
    let similarity = image.getSimilarity(image2, {
      average: false
    });
  ...
  it('check if sum = 0', function () {
    let image = new _common.Image(1, 2, [0, 255, 0, 0, 0, 0, 0, 0]);
    let image2 = new _common.Image(1, 2, [0, 0, 200, 255, 255, 0, 255, 255]);
    let similarity = image.getSimilarity(image2, {
      average: false
    });
  ...
  it('check different images without shift', function () {
    let image = new _common.Image(1, 3, [0, 0, 0, 0, 20, 20, 20, 20, 30, 30, 30, 30]);
    let image2 = new _common.Image(1, 3, [1, 10, 20, 2, 2, 20, 30, 1, 2, 20, 0, 2]);
    let similarity = image.getSimilarity(image2, {
      average: false
    });
  ...
  it('check different images with shift', function () {
    let image = new _common.Image(3, 1, [0, 0, 0, 0, 10, 10, 10, 10, 30, 30, 30, 30]);
    let image2 = new _common.Image(3, 1, [0, 0, 0, 0, 10, 10, 10, 10, 30, 30, 30, 30]);
    let similarity = image.getSimilarity(image2, {
      average: false
    });
    expect(similarity).toStrictEqual([1, 1, 1]);
  ...
  it('check different images with size error', function () {
    let image = new _common.Image(3, 1, [0, 0, 0, 0, 10, 10, 10, 10, 30, 30, 30, 30]);
    expect(function () {
      let image2 = new _common.Image(3, 1, [0, 0], {
        kind: 'GREY'
      });
      image.getSimilarity(image2, {
        average: false
      });
  ...
  it('check different images with other kind', function () {
    let image = new _common.Image(3, 1, [0, 0, 0, 0, 10, 10, 10, 10, 30, 30, 30, 30]);
    let image2 = new _common.Image(3, 1, [0, 0, 0], {
      kind: 'GREY'
    });
    expect(function () {
      image.getSimilarity(image2, {
