...
describe('get a specific channel from an image', function () {
  it('should check channels from a RGBA image', function () {
    let image = new _common.Image(1, 2);
    let red = new _common.Image(1, 2, [230, 100], {
      kind: 'GREY'
    });
    image.setChannel(0, red);
    let green = new _common.Image(1, 2, [83, 140], {
      kind: 'GREY'
    });
    image.setChannel('g', green);
    let blue = new _common.Image(1, 2, [120, 13], {
      kind: 'GREY'
    });
    image.setChannel(2, blue);
    let alpha = new _common.Image(1, 2, [55, 77], {
      kind: 'GREY'
    });
