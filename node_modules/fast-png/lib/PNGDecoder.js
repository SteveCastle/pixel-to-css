...
class PNGDecoder extends iobuffer_1.IOBuffer {
    ...
    decodeChunk() {
        ...
        if (this._checkCrc) {
            ...
            const actualCrc = common_1.crc(new Uint8Array(this.buffer, this.byteOffset + this.offset - crcLength - 4, crcLength), crcLength); // "- 4" because we already advanced by reading the CRC
