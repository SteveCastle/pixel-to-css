...
class PNGEncoder extends iobuffer_1.IOBuffer {
    ...
    encodeData() {
        ...
        const compressed = pako_1.deflate(buffer, this._zlibOptions);
    ...
    writeCrc(length) {
        this.writeUint32(common_1.crc(new Uint8Array(this.buffer, this.byteOffset + this.offset - length, length), length));
    }
}
